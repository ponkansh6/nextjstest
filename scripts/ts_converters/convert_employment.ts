...
const SRC_XLS = path.join(process.cwd(), "data/source", "economics_source", "hon-t01.xls");
const TARGET_CSV = path.join(process.cwd(), "data/source", "employment_indices.csv");
...
function main() {
  ...
  console.log("Loading hon-t01.xls...");
