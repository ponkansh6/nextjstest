#!/usr/bin/env python3
"""
Convert public/economics_source/hon-t13.xls into public/contractual_earnings.csv
"""
...
ROOT = get_root()
SRC_XLS = ROOT / "public" / "economics_source" / "hon-t13.xls"
TARGET_CSV = ROOT / "public" / "contractual_earnings.csv"
...
def main():
    ...
    print("Loading hon-t13.xls...")
    df = pd.read_excel(SRC_XLS, header=6)
    
    out_path = ROOT / "public" / "contractual_earnings.csv"
