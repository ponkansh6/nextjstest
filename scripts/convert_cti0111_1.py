#!/usr/bin/env python3
"""
Convert public/economics_source/cti0111_1.xlsx into the same format as public/cti_data.csv
...
Usage:
  python3 scripts/convert_cti0111_1.py       # overwrite cti_data.csv (default)
  python3 scripts/convert_cti0111_1.py --trial  # write trial CSV and do not touch original
"""
...
SRC_XLSX = ROOT / "public" / "economics_source" / "cti0111_1.xlsx"
...
def load_xlsx_try(xlsx_path: Path):
    # The source file cti0111_1.xlsx has header at row 8 (0-indexed)
