...
export const PALETTES = {
  light:
    "#0c5a9a,#26c2d1,#6c2cb4,#26c6af,#4a3cc3,#9fbb21,#991766,#ff855a,#9d2527,#f66dcf,#762ea1,#d0a720",
  dark: "#0f66ac,#1fa6b3,#773ac1,#1faa96,#5449d0,#89a01b,#ab1b72,#e76737,#b02a2d,#e55dbf,#823bae,#b28f1a",
  oldLight:
