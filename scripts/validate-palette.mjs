...
export const PALETTES = {
  light:
    "#0c5a9a,#26c2d1,#005e8c,#26c6af,#406500,#d2a700,#7e4a00,#ff855a,#9d2527,#f66dcf,#762ea1,#8ca7ff",
  dark: "#0f66ac,#1fa6b3,#006a9d,#1faa96,#497100,#b48f00,#8e5300,#e76737,#b02a2d,#e55dbf,#823bae,#758ee3",
  oldLight:
