    ...
    sections: [
      {
        heading: "データ加工",
        items: [
          { text: "所定内給与・所定外給与：月次実値を2020年基準で指数化" },
          { text: "特別給与：12か月移動平均を算出し、2020年基準で指数化" },
          {
            text: "時間当たり給与：(所定内給与実値 + 所定外給与実値 + 特別給与12か月移動平均) ÷ 総労働時間12か月移動平均 を2020年基準で指数化",
          },
          {
            text: "15歳以上国民当たり給与：((所定内給与実値 + 所定外給与実値 + 特別給与12か月移動平均) × 就業者数) ÷ 15歳以上人口 を2020年基準で指数化",
          },
          { text: "注：特別給与は12か月移動平均、所定内・所定外給与は実値を表示" },
        ],
      },
    ],
  },
