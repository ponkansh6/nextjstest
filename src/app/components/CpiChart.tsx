...
export default function CpiChart({ data }: CpiChartProps) {
  ...
  const stackedColors = [
    "#4a5568", // 住居 (落ち着いた濃いグレーブルー)
    "#718096", // 家具・家事用品 (落ち着いたグレーブルー)
    "#a0aec0", // 被服及び履物 (淡いブルーグレー)
    "#cbd5e0", // 教育 (薄いブルーグレー)
    "#4a7c59", // 交通 (落ち着いた緑)
    "#689f78", // 自動車等関係費 (落ち着いた薄緑)
    "#9fb98a", // 通信 (落ち着いた黄緑)
    "#d6c57d", // 光熱・水道 (落ち着いた薄黄)
    "#a66c4c", // 教養娯楽用品 (落ち着いたオレンジ)
    "#cc937a", // 教養娯楽サービス (落ち着いた薄オレンジ)
    "#c56d6d", // 外食以外食料 (落ち着いた赤)
    "#a35656", // 外食 (落ち着いた濃い赤)
    "#7f8c8d", // 諸雑費 (落ち着いた灰色)
  ];
