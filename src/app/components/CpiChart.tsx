...
export default function CpiChart({ data }: CpiChartProps) {
  ...
  const stackedColors = [
    ...
    "#4387c2", // 被服及び履物: 青のviridis風
    "#3e9db7", // 保健医療: 青緑のviridis風
    "#41a99d", // 教育: 緑青のviridis風
    "#59b585", // 交通: 緑のviridis風
    "#7cc070", // 自動車等関係費: 黄緑のviridis風
    "#a9ca63", // 通信: 黄緑のviridis風
    "#d3ce57", // 光熱・水道: 黄色のviridis風
    "#eeb451", // 教養娯楽サービス: オレンジのviridis風
    "#e88942", // 教養娯楽用品: オレンジ赤のviridis風
    "#d95f46", // 外食以外食料: 赤のviridis風
    "#c64245", // 外食: 赤のviridis風
    "#8c7a7a", // 諸雑費: 灰紫のviridis風
  ];
