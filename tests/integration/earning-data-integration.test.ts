import { calculateAdjustedMetric } from "../../src/lib/cpiData";
...
describe("loadTotalEarningData integration test", () => {
  ...
  it("should have December 2025 non-scheduled/scheduled cash earnings ratio close to the expected value", async () => {
    const data = await loadTotalEarningData();
